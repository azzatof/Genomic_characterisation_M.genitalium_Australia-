...
The following R code was used with [Treatment_outcome_Macrolide_resistance_mutation_data.csv](files/R-studio_input_files/Treatment_outcome_Macrolide_resistance_mutation_data.csv), [Logistic_regression_plot_fluroquinolone_treatment_outcome.csv](R-studio_input_files/Logisitc_regression_plot_fluroquinolone_treatment_outcome.csv) and [Logistic_regression_tetracycline_treatment_outcome_data.csv](R-studio_input_files/Logistic_regression_plot_fluroquinolone_treatment_outcome.csv) as input.  Macrolide is shown as an example; for the other variables, the appropriate factor levels were applied.
